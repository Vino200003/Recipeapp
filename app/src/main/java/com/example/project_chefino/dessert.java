...
public class dessert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(dessert.this, search.class);
                startActivity(intent);
            }
        });
        ...
        bookmarkButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(dessert.this, save.class);
                startActivity(intent);
            }
        });
        ...
        profileButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(dessert.this, profile.class);
                startActivity(intent);
            }
        });
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(dessert.this, addrecipe.class);
                startActivity(intent);
            }
        });
