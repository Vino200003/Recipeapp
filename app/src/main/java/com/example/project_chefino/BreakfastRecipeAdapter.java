...
public class BreakfastRecipeAdapter extends RecyclerView.Adapter<BreakfastRecipeAdapter.RecipeViewHolder> {

    private List<LunchRecipe> recipeList;

    public BreakfastRecipeAdapter(List<LunchRecipe> recipeList) {
